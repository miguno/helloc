...
My template project for writing in the C programming language in 2026.
...
- C language standard is [C23](https://en.cppreference.com/w/c/17), see
...
- Compiler:
  ...
  - You can also use [gcc](https://gcc.gnu.org/) as the compiler. Simply set
    ...
    in the shell environment with `CC=gcc` or `CC=gcc-15`.
